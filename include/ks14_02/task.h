...
public:
    ...
    *   @return void
    */
    virtual void parseFrame(QDataStream& ds) = 0;
...
public:
    ...
    *   @return void
    */
    virtual void parseFrame(QDataStream& inStream) override;
