...
CDialog::CDialog(QWidget* parent) : QDialog(parent)
{
    ...
    connect(pWidgetStep1, &CStep1::showpage, pStackLayout, &QStackedLayout::setCurrentIndex);
    connect(pWidgetStep2, &CStep2::showpage, pStackLayout, &QStackedLayout::setCurrentIndex);
    connect(pWidgetStep3, &CStep3::showpage, pStackLayout, &QStackedLayout::setCurrentIndex);
    connect(pWidgetStep3, &CStep3::closeWindow, this, &CDialog::close);
}